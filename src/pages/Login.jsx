...
export default function Login() {
  return (
    <div className="h-screen flex justify-center items-center m-auto bg-gradient-to-r from-black via-red-700 to-black">
      <div className="bg-white shadow-md rounded-md border px-3 py-5 w-[70%] md:w-[30%]">
