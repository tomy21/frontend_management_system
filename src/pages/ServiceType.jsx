        ...
        <table className='table table-zebra table-xs table-pin-rows table-pin-cols text-xs cursor-pointer'>
          <thead className='border border-slate-200'>
            <tr>
              ...
              <th className='p-3 border-r border-b border-slate-200 w-[20%]'>Service Type</th>
              <th className='p-3 border-r border-b border-slate-200 w-[20%]'>Initial</th>
              <th className='p-3 border-r border-b border-slate-200 w-[20%]'>Description</th>
